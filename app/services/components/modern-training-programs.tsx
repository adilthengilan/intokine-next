    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8 text-white">
        ...
        >
          ...
          <h3 className="text-3xl md:text-4xl font-header tracking-wider mb-4">
            {program.title}
          </h3>
        </motion.div>
...
export default function ModernTrainingPrograms() {
  ...
  const programs = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Outdoor Partner Training",
          desc: "Adventure running together",
        },
      ],
  ...
  console.log("✅ DYNAMIC TRAINING PROGRAMS LOADED", programs);
