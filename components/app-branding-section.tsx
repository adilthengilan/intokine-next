      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {features.length === 0 ? (
          ...
          <>
            ...
            {/* Enhanced pagination dots with glass effect */}
            <div className="flex justify-center gap-3 mt-12">
              {features.map((_, index) => {
                const isActive = scrollPosition >= index * 400 && scrollPosition < (index + 1) * 400;
                return (
                  <motion.div
                    key={index}
                    ...
                    style={{
                      ...
                      borderColor: isActive ? "rgba(0, 0, 0, 0.5)" : "rgba(150, 150, 150, 0.3)",
